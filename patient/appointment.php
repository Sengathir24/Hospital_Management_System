...
<body>
    ...
    ?>
    <div class="container">
        <?php $active='appointments'; include(__DIR__ . '/menu.php'); ?>
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Appointments (<?php echo $result->num_rows; ?>)</p>
                    </td>
